...
export default function Header({ forceShow = false }: { forceShow?: boolean } = {}) {
  ...
  if (!forceShow && (pathname?.startsWith("/tracker") || pathname?.startsWith("/coachlg") || pathname?.startsWith("/workbook") || pathname?.startsWith("/quiz") || pathname?.startsWith("/MMTDS-workbook") || pathname?.startsWith("/7-commandments") || pathname?.startsWith("/thank-you"))) {
    return null;
  }
