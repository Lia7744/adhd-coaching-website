...
export default function WeeklyThankYouPage() {
  ...
  const formLink = currency === "CAD" 
    ? "https://forms.gle/KsxF2Y1jitptJm1k8" 
    : "https://forms.gle/BJ7oiHU1oEcuTdv58";
  
  const calendarLink = "https://calendar.app.google/EXkMQtgBBJrgStGs9";
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-lg text-brand-warm-gray mt-4">
              Thank you for signing up for the <span className="font-bold text-brand-charcoal">Weekly Momentum Plan</span>. There are just two quick steps left to officially kick things off.
            </p>
          </motion.div>
