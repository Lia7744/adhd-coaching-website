  ...
  return (
    <div className={`min-h-[100dvh] ${nunito.className}`} style={{ backgroundColor: C.cream, color: C.charcoal }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          .content-section {
            display: block !important;
            page-break-inside: auto !important;
            padding-top: 2.5rem !important; /* Slightly increased for more breathing room on splits */
      ...
      <div className="max-w-[800px] mx-auto bg-white print:bg-transparent shadow-2xl print:shadow-none pb-20">
        ...
        <section className="front-matter-page relative px-20 pt-12 flex flex-col pb-12" style={{ backgroundColor: C.cream }}>
          <h1 className={`${radley.className} text-[60px] text-center mb-6 leading-tight border-b-4 pb-6 inline-block mx-auto`} style={{ color: C.charcoal, borderColor: C.gold }}>
          ...
          <div className="p-5 rounded-3xl relative my-3" style={{ backgroundColor: '#ebf2ed' }}>
            <h3 className={`${caveat.className} text-[42px] mb-3 leading-none transform -rotate-1`} style={{ color: C.sage }}>Why "manipulating"?</h3>
            <p className="text-[17px] leading-normal text-gray-800 font-medium z-10 relative">
          ...
          <div className="mt-4 space-y-3 pt-4 border-t-[3px] border-dotted" style={{ borderColor: C.gold }}>
            <h4 className="font-black text-[15px] uppercase tracking-widest text-[#6B6B6B]">Two Quick Notes</h4>
            <div className="flex flex-col gap-3">
               <p className="text-[15px] text-gray-700 leading-snug"><strong>The Research:</strong> Everything in the “Real Talk” sections comes from peer-reviewed studies and recognized experts. I’ve included sources at the end. But if you have specific medical questions, please talk with your doctor or a medical professional.</p>
               <p className="text-[15px] text-gray-700 leading-snug"><strong>Blocker Types:</strong> These are patterns I’ve noticed that describe the most common ways ADHD gets in the way. They are not clinical diagnoses or medical terminology. If you’ve taken the “Why Can’t I Just Do the Thing?” quiz, you'll see more around those blockers in chapter 4 (Frozen starter), chapter 5 (Boredom blackout), chapter 6 (Overthinking looper), chapter 7 (Shame spiraler), and chapter 8 (System hopper).</p>
            </div>
          </div>
        </section>
        ...
        <section className="content-section relative px-20 pt-20 px-20 pt-20 bg-white pb-32">
          <div className="space-y-4 text-[17px] leading-[1.6]">
            ...
            {/* Transition bridge moved to the end of The Manipulation section */}
          </div>
        ...
        {/* --- PAGE 6: REAL TALK --- */}
        <section className="content-section relative px-20 pt-20 px-20 pt-20 pb-32" style={{ backgroundColor: C.cream }}>
          <div className="space-y-4 text-[17px] leading-[1.6]">
            ...
            <p className="font-bold text-[21px] mt-10 mb-10">Now, here's the part I wish someone had told me sooner:</p>
        ...
        <section className="content-section relative px-20 pt-20 px-20 pt-20 pb-32" style={{ backgroundColor: '#ffffff' }}>
          <div className="space-y-4 text-[17px] leading-[1.6]">
        ...
        {/* --- PAGE 10: STANDALONE TRANSITION BRIDGE --- */}
        <section className="chapter-title-page min-h-[1056px] flex flex-col justify-center items-center text-center px-20 py-20" style={{ backgroundColor: C.cream }}>
        ...
        <section className="worksheet-page relative px-20 pt-10 pb-8" style={{ backgroundColor: '#ffffff' }}>
          ...
          <p className="text-center font-bold text-[13px] text-[#6B6B6B] italic mb-3">Fill in any or all:</p>
        ...
        <section className="worksheet-page relative px-20 pt-10 pb-8" style={{ backgroundColor: '#ffffff' }}>
          ...
          <p className="text-center font-bold text-[#6B6B6B] italic mb-6 px-10 text-[14px]">
          ...
          <div className="grid grid-cols-1 gap-5 relative z-10 pb-4">
            {[
        ...
        {/* --- PAGE 10: REAL TALK --- */}
        <section className="print:break-before-page content-section relative px-20 pt-20 px-20 pt-20 pb-32" style={{ backgroundColor: C.cream }}>
          <div className="space-y-4 text-[17px] leading-[1.6]">
            <h2 className={`${radley.className} text-[35px] mb-10 border-b-4 inline-block font-bold`} style={{ color: C.sage, borderColor: C.sage }}>THE REAL TALK</h2>
            ...
            <div className="my-6 p-5 rounded-3xl border-[3px] bg-white relative overflow-hidden" style={{ borderColor: C.goldLight }}>
               ...
               <p className="mt-4 text-[10px] font-bold opacity-40 tracking-widest uppercase text-left">(Dodson, 2022)</p>
            </div>
        ...
        {/* --- STANDALONE TRANSITION BRIDGE --- */}
        <section className="chapter-title-page min-h-[1056px] flex flex-col justify-center items-center text-center px-20 py-20" style={{ backgroundColor: C.cream }}>
          <div className="text-center">
            <span className={`${caveat.className} text-[42px]`} style={{ color: C.gold }}>Let's get to it.</span>
            <div className="mt-4 text-5xl" style={{ color: C.sage }}>↓</div>
            <p className="text-center italic text-[17px] text-[#6B6B6B] max-w-xl mx-auto leading-relaxed mt-6">
              Two exercises for this chapter. The first helps you figure out what actually drives you. The second gives you a tool to use that information every day.
            </p>
          </div>
        </section>
        ...
        <section className="worksheet-page relative px-20 pt-10 flex flex-col pb-8" style={{ backgroundColor: '#ffffff' }}>
          ...
          <div className="px-5 py-4 rounded-xl mb-4 flex-shrink-0" style={{ backgroundColor: '#ebf2ed' }}>
          ...
          <div className="space-y-3 flex-shrink-0 relative z-10">
            {[
              ...
              <div key={idx} className="bg-white rounded-2xl p-5 border-2" style={{ borderColor: '#e2dec9' }}>
                ...
                <div className="space-y-6 mt-4 pb-1">
                  <div className="border-b-2 border-dotted w-full" style={{ borderColor: '#e2dec9' }}></div>
                  <div className="border-b-2 border-dotted w-full" style={{ borderColor: '#e2dec9' }}></div>
                </div>
              </div>
            ))}
        ...
        <section className="content-section relative px-20 pt-20 px-20 pt-12 bg-white flex flex-col justify-between pb-32">
          <div className="space-y-4 text-[17px] leading-[1.6]">
            ...
            <p className="print:break-before-page print:mt-0 font-bold text-2xl text-center mt-12 mb-10" style={{ color: C.charcoal }}>
        ...
        <section className="chapter-title-page min-h-[1056px] flex flex-col justify-center items-center text-center px-20 py-20" style={{ backgroundColor: C.cream }}>
          <div className="text-center">
            ...
            <div className="mt-4 text-5xl" style={{ color: C.sage }}>↓</div>
            <p className="text-center italic text-[17px] text-[#6B6B6B] max-w-xl mx-auto leading-relaxed mt-6">
              Two exercises for this chapter. The first is an audit of where decisions are draining you. The second is a concrete plan for making tomorrow easier tonight.
            </p>
          </div>
        </section>
        ...
        <section className="worksheet-page relative px-20 pt-10 flex flex-col pb-10" style={{ backgroundColor: '#ffffff' }}>
          ...
          <div className="mb-4 text-[14px] italic text-[#6B6B6B] px-4">
          ...
          <div className="space-y-4 flex-shrink-0 relative z-10 w-full flex-grow">
            {[
              ...
              <div key={idx} className="bg-white rounded-2xl p-4 border-2" style={{ borderColor: '#e2dec9' }}>
                ...
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-end gap-3 w-full">
                      <div className="w-4 h-4 rounded border-2 flex-shrink-0 mb-[2px]" style={{ borderColor: C.sageLight }}></div>
                      <div className="w-1/3 border-b-[2px] border-dotted h-4" style={{ borderColor: '#e2dec9' }}></div>
                      <span className="font-bold text-[12px] mb-[-4px]" style={{ color: C.sage }}>→ I can:</span>
                      <div className="flex-grow border-b-[2px] border-dotted h-4" style={{ borderColor: '#e2dec9' }}></div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="rounded-xl px-6 py-4 mt-4 flex-shrink-0" style={{ backgroundColor: '#ebf2ed' }}>
              <p className="font-bold text-[16px] mb-4" style={{ color: C.sage }}>The 3 decisions that drain me the most:</p>
              <div className="space-y-4 mb-4 mt-2">
                {[1, 2, 3].map((num) => (
                  <div key={num} className="flex items-end gap-3 w-full">
                    ...
                    <div className="flex-grow border-b-[2px] border-dotted h-6" style={{ borderColor: '#acc2b6' }}></div>
                  </div>
                ))}
              </div>
              <p className="text-center font-bold tracking-[0.05em] uppercase text-[11px] pt-2" style={{ color: C.sage }}>
        ...
        <section className="content-section relative px-20 pt-20 bg-white pb-32">
          <div className="space-y-4 text-[17px] leading-[1.6]">
        ...
        <section className="content-section relative px-20 pt-16 pb-12" style={{ backgroundColor: C.cream }}>
          <div className="space-y-4 text-[17px] leading-[1.6]">
        ...
        <section className="chapter-title-page min-h-[1056px] flex flex-col justify-center items-center text-center px-20 py-20" style={{ backgroundColor: C.cream }}>
          <div className="text-center">
            ...
            <div className="mt-4 text-5xl" style={{ color: C.sage }}>↓</div>
            <p className="text-center italic text-[17px] text-[#6B6B6B] max-w-xl mx-auto leading-relaxed mt-6">
              Two exercises for this chapter. The first helps you figure out exactly what's blocking you and match it to a strategy. The second gives you a tool to shrink any task down to something your brain can actually start.
            </p>
          </div>
        </section>
        ...
        <section className="worksheet-page relative px-20 pt-16 flex flex-col pb-10" style={{ backgroundColor: '#ffffff' }}>
          ...
          <p className="print:break-before-page print:mt-0 font-bold text-[24px] mb-4">Part 2: My Starting Strategies</p>
        ...
        <section className="worksheet-page relative px-20 pt-10 flex flex-col pb-10" style={{ backgroundColor: '#ffffff' }}>
            ...
            <tbody>
              ...
              {[1,2,3,4,5].map(n => (
                <tr key={n} className="border-b" style={{ borderColor: '#e2dec9' }}>
                  <td className="p-3 align-top" style={{ height: '48px' }}>
                    <span className={`${radley.className} font-bold text-xl`} style={{ color: C.sage }}>{n}.</span>
                  </td>
                  <td className="p-3 align-top border-l-2" style={{ borderColor: '#e2dec9', height: '48px' }}></td>
                  <td className="p-3 align-top border-l-2" style={{ borderColor: '#e2dec9', height: '48px' }}></td>
                </tr>
              ))}
            </tbody>
          ...
          <div className="mt-auto p-4 rounded-2xl text-center border-t-[4px]" style={{ backgroundColor: C.cream, borderColor: C.sage }}>
        ...
        <section className="chapter-title-page min-h-[1056px] flex flex-col justify-center items-center text-center px-20 py-20" style={{ backgroundColor: C.cream }}>
          <div className="text-center">
            <span className={`${caveat.className} text-[42px]`} style={{ color: C.gold }}>Alright, let&apos;s deal with it.</span>
            <div className="mt-4 text-5xl" style={{ color: C.sage }}>↓</div>
            <p className="text-center italic text-[17px] text-[#6B6B6B] max-w-xl mx-auto leading-relaxed mt-6">
        ...
        <section className="worksheet-page relative px-20 pt-20 px-20 pt-12 flex flex-col pb-32" style={{ backgroundColor: '#ffffff' }}>
          ...
          <div className="flex-grow min-h-[500px] rounded-2xl border-2 mt-2" style={{ borderColor: '#e2dec9' }}></div>
        </section>
        ...
        <section className="worksheet-page relative px-20 pt-10 flex flex-col pb-10" style={{ backgroundColor: '#ffffff' }}>
          ...
          <table className="w-full border-collapse text-[13px] mb-4 flex-shrink-0">
            <thead>
              <tr style={{ backgroundColor: C.cream }}>
            ...
            <tbody>
              {[1,2,3,4,5].map(n => (
                <tr key={n} className="border-b" style={{ borderColor: '#e2dec9' }}>
                  <td className="p-3 align-top" style={{ height: '60px' }}>
        ...
        <section className="worksheet-page relative px-20 pt-20 px-20 pt-12 flex flex-col bg-white pb-32">
          ...
          <div className="flex-grow min-h-[400px] rounded-2xl border-2 mt-2" style={{ borderColor: '#e2dec9' }}></div>
        </section>

        {/* --- PAGE 38: CH6 WORKBOOK PAGE 1b — THE SORT --- */}
        <section className="worksheet-page print:break-before-page relative px-20 pt-16 flex flex-col pb-16" style={{ backgroundColor: C.cream }}>
          <p className="font-black uppercase tracking-[0.15em] text-sm mb-6" style={{ color: C.sage }}>Part 2: The Sort</p>
        ...
        <section className="worksheet-page relative px-20 pt-10 flex flex-col bg-white pb-10">
          ...
          <div className="mb-4 px-4 py-3 rounded-xl text-[12px] italic" style={{ backgroundColor: '#ebf2ed', color: C.charcoal }}>
        ...
        <section className="worksheet-page print:break-before-page relative px-20 pt-10 flex flex-col pb-10" style={{ backgroundColor: C.cream }}>
          ...
          <div className="mt-auto p-4 rounded-2xl text-center border-t-[4px]" style={{ backgroundColor: '#ffffff', borderColor: C.sage }}>
            <p className="text-[15px] font-medium leading-relaxed text-gray-700">
        ...
        <section className="worksheet-page relative px-20 pt-8 flex flex-col bg-white pb-8">
          ...
          <div className="space-y-3 flex-grow flex flex-col">
            <div>
              <p className="font-bold text-[14px] mb-1" style={{ color: C.charcoal }}>What was the task I didn&apos;t do (or did &ldquo;badly&rdquo;)?</p>
              <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
              <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
            </div>

            <div>
              <p className="font-bold text-[14px]" style={{ color: C.charcoal }}>What story did my brain immediately tell me about it?</p>
              <p className="text-[12px] italic text-gray-400 mb-1">(example: &ldquo;I&apos;m lazy,&rdquo; &ldquo;I&apos;ll never get it together,&rdquo; &ldquo;everyone else can do this&rdquo;)</p>
              <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
              <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
            </div>
            ...
            <div className="bg-white rounded-2xl py-3 px-4 border-2" style={{ borderColor: '#e2dec9' }}>
              ...
              <div className="grid grid-cols-2 gap-y-1 gap-x-2">
                {["Avoided the task entirely", "Avoided the people connected to the task", "Shut down (stayed in bed, scrolled, zoned out)", "Tried to distract myself from the feeling", "Beat myself up internally for hours or days", "Took it out on someone else"].map((item, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 flex-shrink-0 opacity-40" viewBox="0 0 100 100" fill="none" stroke={C.sage} strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"><rect x="15" y="15" width="70" height="70" rx="8"/></svg>
                    <span className="text-[12px] text-gray-700">{item}</span>
                  </div>
                ))}
                <div className="flex items-center gap-2 col-span-2 mt-1">
                  <svg className="w-3.5 h-3.5 flex-shrink-0 opacity-40" viewBox="0 0 100 100" fill="none" stroke={C.sage} strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"><rect x="15" y="15" width="70" height="70" rx="8"/></svg>
                  <div className="flex-grow border-b-[2px] border-dotted" style={{ borderColor: '#e2dec9' }}></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl py-3 px-4 border-[3px]" style={{ borderColor: C.goldLight }}>
              ...
              <div className="space-y-2">
                <div>
                  <p className="text-[12px] font-bold uppercase tracking-widest" style={{ color: C.charcoal }}>The fact <span className="font-normal normal-case opacity-60">(what actually happened)</span></p>
                  <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
                </div>
                <div>
                  <p className="text-[12px] font-bold uppercase tracking-widest mt-2" style={{ color: C.charcoal }}>The story <span className="font-normal normal-case opacity-60">(what my brain told me it meant)</span></p>
                  <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
                </div>
              </div>
              <div className="mt-3 space-y-3">
                <div>
                  <p className="font-bold text-[13px] text-gray-700 mb-1">What do you notice from those two lines?</p>
                  <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
                </div>
                <div>
                  <p className="font-bold text-[13px] text-gray-700 mb-1">Now, reframe the story so it&apos;s based off facts:</p>
                  <div className="border-b-[2px] border-dotted mt-4" style={{ borderColor: '#e2dec9' }}></div>
                </div>
              </div>
        ...
        <section className="content-section relative px-20 pt-20 bg-white pb-10">
          <div className="space-y-4 text-[17px] leading-[1.6]">
            <h2 className={`${radley.className} text-[35px] mb-6 border-b-4 inline-block font-bold`} style={{ color: C.sage, borderColor: C.sage }}>THE MANIPULATION</h2>
        ...
        {/* --- PAGE 77: CHAPTER 8 THE 7 COMMANDMENTS --- */}
        <section className="content-section print:break-before-page relative px-20 pt-10 bg-white pb-20">
          <div className="text-center mb-5">
            <p className="text-[11px] uppercase tracking-[0.25em] font-bold mb-1 opacity-50" style={{ color: C.charcoal }}>introducing</p>
            <h3 className={`${caveat.className} text-[46px] leading-tight`} style={{ color: C.charcoal }}>
              The 7 Commandments of<br />ADHD Systems
            </h3>
            <div className="mx-auto mt-2 w-24 h-[4px] rounded-full" style={{ backgroundColor: C.gold }}></div>
          </div>
        ...
        {/* --- PAGE 81: BUILD YOUR SYSTEM (CONT) --- */}
        <section className="worksheet-page print:break-before-page relative px-20 pt-16 flex flex-col space-y-3 pb-20" style={{ backgroundColor: C.cream }}>
        ...
        <section className="content-section relative px-16 pt-16 bg-white flex flex-col pb-32">
          <div className="space-y-4 text-[17px] leading-[1.6]">
            <h2 className={`${radley.className} text-[35px] mb-6 border-b-4 inline-block font-bold`} style={{ color: C.sage, borderColor: C.sage }}>THE BIT</h2>
        ...
        <section className="content-section print:break-before-page relative px-16 pt-16 bg-white flex flex-col pb-32">
          <div className="space-y-4 text-[17px] leading-[1.6]">
        ...
        {/* --- PAGE 55: CONCLUSION --- */}
        <section className="content-section relative px-16 pt-16 bg-white flex flex-col justify-center text-center pb-32">
        ...
        <section className="content-section print:break-before-page relative px-16 pt-16 bg-white flex flex-col justify-center pb-32">
