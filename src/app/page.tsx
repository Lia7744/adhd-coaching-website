          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center space-y-6">
            <Reveal>
              <motion.div
                ...
                className="inline-block text-brand-charcoal text-2xl sm:text-3xl font-handwriting italic mb-4"
              >
            ...
            <Reveal delay={0.45}>
              <div className="flex flex-col items-center gap-4">
                <button
                  ...
                  className="group relative inline-flex items-center justify-center gap-3 bg-brand-sage text-white h-14 px-8 rounded-full text-lg font-bold shadow-md transition-all hover:scale-105 active:scale-95 hover:bg-brand-sage-hover"
                >
